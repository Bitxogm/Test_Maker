    ...
    <div className="min-h-screen flex items-center justify-center bg-dark-900 p-4">
      <div className="w-full max-w-md bg-dark-800 border-2 border-neon-cyan p-8 shadow-[0_0_20px_rgba(0,255,245,0.1)]">
        <div className="text-center mb-8">
          ...
          <p className="text-sm tracking-[0.2em] text-gray-400 font-bold uppercase">INICIAR SESIÓN</p>
        </div>
        ...
        <div className="mt-8 text-center">
          <Link href="/register" className="text-xs text-gray-400 hover:text-neon-cyan transition-all tracking-wider font-bold">
            ¿NO TIENES CUENTA? <span className="text-neon-cyan border-b border-neon-cyan/30">REGISTRARSE</span>
          </Link>
        </div>
      </div>
    </div>
