  ...
  return (
    <header className="h-[60px] flex items-center justify-between px-6 bg-dark-800 border-b border-dark-700">
      <div className="flex items-center space-x-3">
        <h1 className="text-xl font-black text-neon-cyan glow-cyan tracking-tighter">TESTLAB AI</h1>
      ...
      <div className="flex items-center space-x-6">
        {user ? (
          <>
            <span className="text-sm font-mono text-gray-400">{user.email || user.sub}</span>
            <button
