    ...
    <div className="min-h-screen flex items-center justify-center bg-dark-900 p-4">
      <div className="w-full max-w-md bg-dark-800 border-2 border-neon-purple p-8 shadow-[0_0_20px_rgba(191,0,255,0.1)]">
        ...
        <div className="mt-8 text-center">
          <Link href="/login" className="text-xs text-gray-400 hover:text-neon-purple transition-all tracking-wider font-bold">
            ¿YA TIENES CUENTA? <span className="text-neon-purple border-b border-neon-purple/30">LOGIN</span>
          </Link>
        </div>
      </div>
    </div>
